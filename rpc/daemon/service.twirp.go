...
// NewZapretDaemonProtobufClient creates a Protobuf client that implements the ZapretDaemon interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewZapretDaemonProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) ZapretDaemon {
...
func (c *zapretDaemonProtobufClient) Restart(ctx context.Context, in *RestartRequest) (*RestartResponse, error) {
...
func (c *zapretDaemonProtobufClient) callRestart(ctx context.Context, in *RestartRequest) (*RestartResponse, error) {
...
func (s *zapretDaemonServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *zapretDaemonServer) ProtocGenTwirpVersion() string {
	return "v8.1.3"
}
...
func (s *zapretDaemonServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "daemon", "ZapretDaemon")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
